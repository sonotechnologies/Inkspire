        ...
        <>
          ...
          <Row className="text-center mb-5 g-4">
            <Col md={4}>
              ...
              <p className="text-muted">Readers</p>
            </Col>
          ...
          <Row className="align-items-center p-5 rounded shadow-sm bg-white">
            <Col md={6}>
              <h2 className="fw-bold mb-3">Why Inkspire?</h2>

              <p className="text-muted">
                Discover books you didn't know you needed. Inkspire blends
                powerful discovery with a beautiful reading marketplace.
              </p>
              ...
              >
                ...
                <Form className="d-flex mt-4">
                  ...
                  <Button
                    style={{
                      ...buttonStyle,
                      boxShadow: "0 0 18px rgba(255,200,0,.4)",
                    }}
                  >
                    Subscribe
                  </Button>
